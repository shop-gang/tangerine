# NEXT STEPS: Core MVP Features (Phase 1)

This document mirrors the implementation checklist in `ISSUES.md`. Check off items as they are completed. Keep this in sync with `ISSUES.md`.
